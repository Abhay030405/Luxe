...
<div {{ $attributes->merge(['class' => 'rounded-lg border p-4 flex items-start space-x-3 ' . $styles[$type]]) }}>
    ...
    <button @click="show = false" class="flex-shrink-0 text-current hover:opacity-75 transition">
