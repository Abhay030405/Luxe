...
<div class="space-y-6">
    ...
    <x-card>
        <div class="flex flex-wrap items-center gap-4">
            ...
            <div class="flex-1 min-w-[200px]">
                <input type="text" placeholder="Search products..." class="w-full rounded-lg border-gray-300 focus:border-blue-600 focus:ring-blue-600">
            </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-xs text-gray-500">Created {{ date('M d, Y', strtotime('-'.$i.' days')) }}</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm font-semibold text-gray-900">${{ rand(50, 500) }}.99</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            @php $stock = rand(0, 200); @endphp
                            <span class="text-sm font-medium {{ $stock < 20 ? 'text-red-600' : 'text-gray-900' }}">
                                {{ $stock }} units
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            @php
                                $statuses = ['Published', 'Draft', 'Out of Stock'];
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-2">
            ...
            <x-button variant="outline" size="sm">Publish</x-button>
            <x-button variant="outline" size="sm">Unpublish</x-button>
