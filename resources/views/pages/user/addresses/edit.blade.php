...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-sm text-gray-600">Update your delivery address information</p>
    </div>
    ...
    <div class="lg:grid lg:grid-cols-12 lg:gap-8">
        ...
        <div class="lg:col-span-9">
            <x-card title="Edit Address Information">
                <form method="POST" action="{{ route('addresses.update', $address->id) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex space-x-4">
                            <label class="flex items-center">
                                <input type="radio" name="address_type" value="home" {{ $address->addressType === 'home' ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-600">
                                <span class="ml-2 text-sm text-gray-700">Home</span>
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="address_type" value="work" {{ $address->addressType === 'work' ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-600">
                                <span class="ml-2 text-sm text-gray-700">Work</span>
                            </label>
                            <label class="flex items-center">
                                <input type="radio" name="address_type" value="other" {{ $address->addressType === 'other' ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-600">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="is_default" id="is_default" value="1" {{ $address->isDefault ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-600">
