...
class VendorOrderCancelledMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Order from '.$this->vendorOrder->vendor->business_name.' Has Been Cancelled',
        );
    }
    ...
    {
        return new Content(
            view: 'emails.vendor-orders.cancelled',
            with: [
